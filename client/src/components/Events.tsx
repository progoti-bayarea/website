          ...
          const rowBody = (
            <>
              ...
              {!isComingSoon && event.registrationUrl && (
                <a href={event.registrationUrl} target="_blank" rel="noopener noreferrer" className="flex items-center bg-primary text-white font-semibold text-sm px-3 py-1.5 rounded-full hover:bg-primary/90 transition-colors flex-shrink-0 group/btn ml-2">
                  <span className="hidden sm:inline">Register Now</span>
                  <ArrowRight className="w-4 h-4 sm:ml-1 transition-transform group-hover/btn:translate-x-1" />
                </a>
              )}
            </>
          );
                ...
                <div className="flex-1 p-6 flex flex-col">
                  ...
                  {event.registrationUrl && (
                    <div className="mt-6 pt-6 border-t border-border flex justify-end">
                      <a href={event.registrationUrl} target="_blank" rel="noopener noreferrer" className="flex items-center bg-primary text-white font-bold text-base px-5 py-2.5 rounded-full hover:bg-primary/90 transition-colors group/btn">
                        Register Now
